  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-screen-padding">
      <form
        ...
        className="bg-white/15 backdrop-blur-xl rounded-2xl shadow-card p-6 max-w-3xl w-full transition-card"
      >
        <h2 className="text-title font-heading text-text-primary mb-4 text-center">Add New Idea</h2>
